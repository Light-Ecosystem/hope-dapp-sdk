...
export const WETH = {
  ...
  [ChainId.BASE_GOERLI]: new Token(ChainId.BASE_GOERLI, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapper ETH'),
  // [ChainId.ARBITRUM]: new Token(ChainId.HOPE, '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1', 18, 'WETH', 'Wrapper ETH'),
  [ChainId.ARBITRUM_GOERLI]: new Token(ChainId.ARBITRUM_GOERLI, '0xe39ab88f8a4777030a534146a9ca3b52bd5d43a3', 18, 'WETH', 'Wrapper ETH'),
}
