...
export const FACTORY_ADDRESS_MAP:{[chainId: number]: string} = {
  ...
  // [ChainId.BASE]: '0x',
  [ChainId.BASE_GOERLI]: '0x59fEe49D4058699d951bA9937C948f83141Ba517',
  // [ChainId.ARBITRUM]: '0x',
  [ChainId.ARBITRUM_GOERLI]: '0x59fEe49D4058699d951bA9937C948f83141Ba517'
}
...
export const INIT_CODE_HASH_MAP:{[chainId: number]: string} = {
  ...
  // [ChainId.BASE]: '0x0fe0976a8394a59cb43ce8ed266ed3ad7b48c0538114ef1bea17c3f7f4138f2c',
  [ChainId.BASE_GOERLI]: '0x0fe0976a8394a59cb43ce8ed266ed3ad7b48c0538114ef1bea17c3f7f4138f2c',
  // [ChainId.ARBITRUM]: '0x0fe0976a8394a59cb43ce8ed266ed3ad7b48c0538114ef1bea17c3f7f4138f2c',
